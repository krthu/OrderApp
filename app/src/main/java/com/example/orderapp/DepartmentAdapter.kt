...
class DepartmentAdapter(val context: Context, val departments: List<Department>,val fragment: DepartmentFragment): RecyclerView.Adapter<DepartmentAdapter.ItemViewHolder>() {
        ...
        init {
            view.setOnClickListener{
                ...
                if (position != RecyclerView.NO_POSITION){
                    fragment.onItemClick(departments[position].documentId)
                }
            }
        }
